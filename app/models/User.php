...
class User extends Model
{
      ...
      public function save()
      {
            ...
            user_hp=:user_hp, user_pos=:user_pos, user_role=:user_role, user_aktif=:user_aktif, created_at=:created_at";
      ...
      public function update()
      {
            ...
            if (!empty($user_password)) {
                  $sql = "UPDATE tb_users
                  SET user_email=:user_email, user_password=PASSWORD(:user_password), user_nama=:user_nama, user_alamat=:user_alamat, 
                  user_hp=:user_hp, user_pos=:user_pos, user_role=:user_role, user_aktif=:user_aktif, updated_at=:updated_at
