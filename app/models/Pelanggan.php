...
class Pelanggan extends Model
{
    ...
    {
        $query = "SELECT gol_id, gol_nama FROM tb_golongan";
        $stmt = $this->db->prepare($query);
        $stmt->execute();
    ...
    {
        $query = "SELECT user_id, user_nama FROM tb_users";
        $stmt = $this->db->prepare($query);
        $stmt->execute();
    ...
    public function update()
    {
        ...
        $sql = "UPDATE tb_pelanggan
                  SET pel_id_gol=:pel_id_gol, pel_no=:pel_no, pel_nama=:pel_nama, 
                  pel_hp=:pel_hp, pel_ktp=:pel_ktp, pel_seri=:pel_seri, pel_meteran=:pel_meteran, 
                  pel_aktif=:pel_aktif, pel_id_user=:pel_id_user, update_at=:update_at
                  WHERE pel_id=:pel_id";
